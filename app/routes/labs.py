...
&lt;/html&gt;</code></pre>
    ...
    "lab-09-network-analysis": {
        "title": "Laboratorio 09: Análisis de Tráfico de Red (Wireshark)",
    ...
    "lab-10-full-audit-simulation": {
        "title": "Laboratorio 10: Simulación de Auditoría Web Completa (Capstone Project)",
